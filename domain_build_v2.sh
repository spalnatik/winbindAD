...
case $distro in
	...
	function sssd {
		...
		#elif type winbind &>/dev/null; then
	}
	function winbind {
    ...
    *)
	    ...
	    function sssd {
    	    ...
    	    function winbind {
            wget -O win_os_detector.sh https://raw.githubusercontent.com/spalnatik/winbindAD/main/win_os_detector.sh
...
#check_resource_group_exists() {
 #   local rg_name="$1"
    # Add your logic here to check if the resource group exists
